  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 text-white">
      <p className="text-lg mb-6 leading-relaxed text-gray-300">
        Welcome to{" "}
        <span className="font-semibold text-blue-400">ZeetLab</span>, your
      ...
      <p className="text-lg mb-6 leading-relaxed text-gray-300">
        At ZeetLab, we offer a rich collection of DSA problems organized
      ...
      <h2 className="text-3xl font-semibold mb-6">How to Use ZeetLab</h2>
      ...
      <p className="text-lg leading-relaxed text-gray-300">
        I'm Khushi Shrivastava, a passionate software developer who loves to code and
        build tools that make learning and growth easier for developers
        worldwide. I have keen
        interest in algorithmic problem solving, I created ZeetLab to
