...
const HomePage = () => {
  ...
  ✨ Join ZeetLab built for real-world problem solvers
</div>
          ...
          "
            >
              ...
              <p className="text-xl text-gray-300 leading-relaxed">
                ZeetLab is a modern coding platform that offers real-world
                ...
                skills, ZeetLab provides the tools and environment to excel.{" "}
                <br />
                <br />
                Whether you're a beginner taking your first steps or a seasoned
                developer aiming to stay sharp, ZeetLab makes practice
